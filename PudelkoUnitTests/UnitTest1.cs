...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        //14 objetosc i pole
        [DataTestMethod, TestCategory("Pole i Objêtoœæ")]
        ...
        [TestMethod, TestCategory("Pole i Objêtoœæ")]
        ...
        [DataRow(1.8, 2.2, 3.4, 5.4, 3.9, 4.2)]
        [DataRow(5, 5, 5, 3, 3, 3)]
        ...
        {
            var (a, b, c) = (2572, 9121, 100); // in milimeters, ValueTuple
            Pudelko p = (a, b, c);
        ...
        {
            var p = new Pudelko(2, 2.41, 3.237);
